  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        initLogos(
          (volleyballProfile as any).team_logos,
          (volleyballProfile as any).college_logo_url
        );

        const ov = profile.overview;

        reset({
          born: volleyballProfile.born || ov?.born || '',
          age: toFormString(volleyballProfile.age || ov?.age),
          height: volleyballProfile.height || ov?.height || '',
          dominant_hand: volleyballProfile.dominant_hand || ov?.dominant_hand || '',
          player_position: volleyballProfile.player_position ?? '',
          college_university: volleyballProfile.college_university || ov?.college_university || '',
