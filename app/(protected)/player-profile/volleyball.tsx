...
import { PickedImage, VolleyballProfileFormValues } from '../../../src/types';
...
export default function VolleyballProfileScreen() {
  ...
  const onSubmit = async (values: VolleyballProfileFormValues) => {
    ...
    try {
      ...
      setError('Could not save your Volleyball profile. Please check your entries and try again.');
    } finally {
      setIsSaving(false);
    }
  };
  ...
  if (isViewing) {
    ...
    return (
      <PlayerSportDetailView
        ...
        fields={fields}
        careerStatsHeader="Volleyball Stats"
        careerStatsColumns={[
  ...
  return (
    <ScreenContainer edges={['bottom']} scroll>
      ...
      <View style={styles.topModeBar}>
        <Text style={styles.topModeTitle}>Editing Volleyball Profile</Text>
