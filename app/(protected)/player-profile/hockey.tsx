  ...
  return (
    <ScreenContainer edges={['bottom']} scroll>
      ...
      <View style={styles.topModeBar}>
        <Text style={styles.topModeTitle}>Editing Hockey Profile</Text>
      ...
      <Button label="Save Hockey Profile" onPress={handleSubmit(onSubmit)} loading={isSaving} style={styles.submitButton} />
    </ScreenContainer>
  );
}
